...
If the shared file is unavailable or unreadable, report that limitation and use
the available repository instructions; do not claim the harness was loaded.
